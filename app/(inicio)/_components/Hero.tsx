            ...
            <div className="w-[90%] flex flex-col md:flex-row md:min-h-[80vh] gap-x-8 items-center justify-center max-w-300">
                <div className="flex flex-col mb-16 md:mb-0">
                    ...
                    <div className="w-full text-center">
                        ...
                        <Link href={'/Mesas-De-Juego'} className="font-semibold text-white px-8 py-4 bg-[#B86112] hover:bg-[#cb7818]">CATALOGO</Link>
                    </div>
                </div>
                <div className="flex flex-col">
                    ...
                    <div className="w-full text-center">
                        ...
                        <Link href={'/Productos-Del-Hogar'} className="font-semibold text-white px-8 py-4 bg-[#B86112] hover:bg-[#cb7818]">CATALOGO</Link>
                    </div>
                </div>
            </div>
        </section>
